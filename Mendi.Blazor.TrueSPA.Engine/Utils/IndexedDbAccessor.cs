...
namespace Mendi.Blazor.TrueSPA.Engine.Utils
{
    public class IndexedDbAccessor : IDisposable, IAsyncDisposable
    {
        ...
        const string resourceName = "NavigatorAccessor.js";
...
#pragma warning disable CS8602 // Dereference of a possibly null reference.
        ...
        private async Task WaitForReference(CancellationToken token = default)
        {
            ...
            {
                _accessorJsRef = new(await _jsRuntime.InvokeAsync<IJSObjectReference>("import", cancellationToken: token, "Mendi.Blazor.TrueSPA.NavEngine/content/js/NavigatorAccessor.js"));
            }
        }
