...
namespace Mendi.Blazor.TrueSPA.Common.Commands
{
    public class BuildPageRoutes
    {
        ...
        private async Task BuildRoutes(string basePath, string path, bool isForce)
        {
            ...
            {
                if (lines[i].Contains("public override void BuildPageRoutes()"))
                {
                    startIndex = i;
                    break;
                }
...
ContinueProcess:
            ...
            try
            {
                ...
                sb.AppendLine("base.BuildPageRoutes();");
                ...
                sb.AppendLine($"       var singlePageRoute = new SinglePageRoute{{AppId = getPage.Value.AppId,AppName = getPage.Value.AppName,Component = getPage.Value.ComponentName}};");

                sb.AppendLine("        SaveCurrentPage(singlePageRoute);");
                sb.AppendLine("    }");
        ...
        protected private void SaveGeneratedRoutes(string code, string filePath)
        {
            ...
            if (File.Exists(filePath))
            {
                ...
                newMethodCode.AppendLine("public override void BuildPageRoutes()");
