...
namespace Mendi.Blazor.TrueSPA.Common.Decorators
{
    ...
    public class MarkAsSinglePageRoutableComponentAttribute : Attribute
    {
        //
        // Summary:
        ...
        public MarkAsSinglePageRoutableComponentAttribute(string appName, bool isDefault, int appId)
        {
